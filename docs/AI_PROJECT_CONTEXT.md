...
> **Версия**: 1.8 (Актуализация: Mail Integration + AmoCRM Sync + Bot Hardening)
...
- [x] **Mail Integration**: Переезд на Beget, настройка SPF/DKIM/DMARC.
- [x] **Stability**: Исправление конфликтов Telegram бота и зацикливания вебхуков.
