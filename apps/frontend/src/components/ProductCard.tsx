...
export function ProductCard({ product }: ProductCardProps) {
    ...
    return (
        <Link href={`/catalog/${product.id}`} className="block h-full group">
            <Card className="h-full w-full overflow-hidden border border-industrial-border bg-industrial-panel relative transition-all duration-500 hover:border-safety-orange hover:shadow-[0_0_50px_rgba(255,61,0,0.25)] flex flex-col rounded-none">
                ...
                {/* Image Container - flexible height, min-height ensuring visibility */}
                <div className="relative w-full h-48 sm:h-56 bg-industrial-surface overflow-hidden border-b border-industrial-border group-hover:border-safety-orange/50 transition-colors shrink-0">
